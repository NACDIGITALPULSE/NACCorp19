  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-gradient-to-r from-niger-orange to-niger-green relative overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 w-40 h-40 bg-white/5 rounded-full blur-xl animate-bounce"></div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in">
            <Link to="/inscription-nif-rccm">
              <Button size="lg" className="bg-white text-niger-orange hover:bg-gray-100 shadow-lg group transition-all duration-300 hover:scale-105">
            ...
            <Link to="/contact">
              <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-niger-orange shadow-lg group transition-all duration-300 hover:scale-105">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-12">
            <div className="text-center group cursor-pointer">
              <div className="text-3xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">2000+</div>
              <div className="text-white/80 group-hover:text-white transition-colors">Entreprises créées</div>
            </div>
            <div className="text-center group cursor-pointer">
              <div className="text-3xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">98%</div>
              <div className="text-white/80 group-hover:text-white transition-colors">Taux de satisfaction</div>
            </div>
            <div className="text-center group cursor-pointer">
              <div className="text-3xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">5j</div>
              <div className="text-white/80 group-hover:text-white transition-colors">Délai moyen</div>
            </div>
            <div className="text-center group cursor-pointer">
              <div className="text-3xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">24/7</div>
              <div className="text-white/80 group-hover:text-white transition-colors">Support disponible</div>
            </div>
          </div>
        </div>
      </section>
